  ...
  const fetchEmails = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setToEmailCareerGeneral(data.data.toEmailCareerGeneral ?? "");
        setToEmailVendor(data.data.toEmailVendor);
      ...
      <AdminItemContainer>
        ...
        <div className="flex flex-col gap-5 border-r-gray-300 p-5">
          <div className="flex flex-col gap-5">
            <div className="space-y-4">
              <Label className="">To email (Vendor Form)</Label>
              <Input
                value={toEmailVendor}
                onChange={(e) => setToEmailVendor(e.target.value)}
              />
            </div>
            <div className="space-y-4">
              <Label className="">To email (Career Form – Job Specific)</Label>
              <Input
                value={toEmailCareer}
            ...
            <div className="space-y-4">
              <Label className="">To email (Career Form – General)</Label>
              <Input
                value={toEmailCareerGeneral}
                onChange={(e) => setToEmailCareerGeneral(e.target.value)}
              />
            </div>
            <div className="space-y-4">
              <Label className="">To email (Contact Form)</Label>
              <Input

...
import SmartPagination from "..//enquiries/Pagination";
...
const AdminGeneralCareerEnquiry = () => {
    ...
    const fetchEnquiriesData = async () => {
      try {
        const response = await fetch(
          `/api/admin/general-career?page=${page}&limit=10`,
        );
        if (response.ok) {
        ...
        console.error("Error fetching general career enquiries:", error);
      }
    };
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      const response = await fetch(`/api/admin/general-career/bulk-delete`, {
        method: "POST",
        headers: {
  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl">General Career Enquiries</h1>
      </div>
      ...
      <div className="flex flex-col gap-3 min-h-[calc(100vh-200px)]">
        ...
        {enquiries && enquiries.length > 0 ? (
                          ...
                          <div className="p-5 flex flex-col gap-5 relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                            <div className="grid grid-cols-1 gap-4 text-sm">
                              ...
                              <div className="flex flex-col">
                                ...
                                <span className="text-gray-900">
                                  {selectedEnquiry.currentLocation}
                                </span>
                              </div>
                              ...
                              <div className="flex gap-2">
                                ...
                                {selectedEnquiry.coverLetter ? (
                                  <a
                                    href={selectedEnquiry.coverLetter}
                                    target="_blank"
                                    rel="noreferrer"
                                  >
          ...
          <div>No general career enquiries available</div>
        )}
      </div>
...
export default AdminGeneralCareerEnquiry;

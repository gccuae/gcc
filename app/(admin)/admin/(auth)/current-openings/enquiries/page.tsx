...
const AdminEnquiry = () => {
    ...
    useEffect(() => {
        ...
        const fetchEnquiriesData = async () => {
            try {
                const response = await fetch(`/api/admin/career?page=${page}&limit=10`);
    ...
    const handleBulkDelete = async () => {
        ...
        try {
            const response = await fetch(`/api/admin/career/bulk-delete`, {
                method: "POST",
                headers: {
                                                ...
                                                <div className="p-5 flex flex-col gap-5 relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                                    ...
                                                    <div className="grid grid-cols-1 gap-4 text-sm">
                                                        ...
                                                        <div className="flex gap-2">
                                                            <label className="font-semibold text-gray-600">Cover Letter</label>
                                                            <a href={selectedEnquiry.coverLetter} target='black'><IoDocumentText className='text-xl' /></a>
                                                        </div>

                                                        <div className="flex gap-2">
                                                            <label className="font-semibold text-gray-600">Resume</label>
                                                            <a href={selectedEnquiry.resume} target='black'><IoDocumentText className='text-xl' /></a>
                                                        </div>

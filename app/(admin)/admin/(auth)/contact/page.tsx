            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-1">
                ...
                <Input
                  type="text"
                  placeholder="Title"
                  {...register("firstSection.pageTitle", {
                    required: "Page Title is required",
                  })}
                />
                {errors.firstSection?.pageTitle && (
                  <p className="text-red-500">
                    {errors.firstSection?.pageTitle.message}
                  </p>
                )}
              </div>
              <div className="flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-1">
                ...
                <Input
                  ...
                  {...register("secondSection.mainTitle", {
                    required: "Main Title is required",
                  })}
                />
                {errors.secondSection?.mainTitle && (
                  <p className="text-red-500">
                    {errors.secondSection?.mainTitle.message}
                  </p>
                )}
              </div>
              <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-1">
                ...
                <Input
                  ...
                  {...register("secondSection.addressTitle", {
                    required: "Address Title is required",
                  })}
                />
                {errors.secondSection?.addressTitle && (
                  <p className="text-red-500">
                    {errors.secondSection?.addressTitle.message}
                  </p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <Textarea
                  ...
                  {...register(`secondSection.location`, {
              ...
              <div className="flex flex-col gap-1">
                ...
                <Input
                  type="text"
                  placeholder="Address Title"
                  {...register("secondSection.telephone", {
                    required: "Telephone is required",
                  })}
                />
                {errors.secondSection?.telephone && (
                  <p className="text-red-500">
                    {errors.secondSection?.telephone.message}
                  </p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <Input
                  type="text"
                  placeholder="Address Title"
                  {...register("secondSection.fax", {
                    required: "Fax is required",
                  })}
                />
                {errors.secondSection?.fax && (
                  <p className="text-red-500">
                    {errors.secondSection?.fax.message}
                  </p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <Textarea
                  placeholder="Description"
                  {...register(`secondSection.timings`, {
                    required: "Value is required",
                  })}
                />
                {errors.secondSection?.timings && (
                  <p className="text-red-500">
                    {errors.secondSection?.timings.message}
                  </p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <Input
                  ...
                  {...register("secondSection.getDirection")}
                />
              </div>

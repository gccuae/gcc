...
const GroupCompanyPage = () => {
    ...
    const { register, handleSubmit, setValue, control, formState: { errors } } = useForm<GroupCompanyFormProps>();
    ...
    return (
        <div className='flex flex-col gap-5'>
            <form className='flex flex-col gap-5' onSubmit={handleSubmit(handleAddGroupCompany)}>
                    ...
                    <div className='p-5 rounded-md flex flex-col gap-2'>
                        ...
                        <div>
                                        ...
                                        <div className='flex flex-col gap-2'>
                                            <div className='flex flex-col gap-2'>
                                                <div className='flex flex-col gap-2'>
                                                    ...
                                                    {errors.firstSection?.items?.[index]?.number && <p className='text-red-500'>{errors.firstSection?.items?.[index]?.number.message}</p>}
                                                </div>
                                                <div className='flex flex-col gap-2'>
                            ...
                            <div className='flex justify-end mt-2'>
                                <Button type='button' addItem onClick={() => firstSectionAppend({ logo: "", logoAlt: "", number: "", value: "" })}>Add Item</Button>
                            </div>
                        </div>

      ...
      <div className="container">
        ...
        <div>
          <div className="relative">
            <div className=" absolute top-10 md:top-2/4 md:right-[-10px] xl:top-4/6 xl:-right-12 z-50 w-full md:w-[50px] h-[50px] xl:w-[94px] xl:h-[94px] md:bg-black rounded-full flex items-center justify-end md:justify-center gap-2 xl:gap-4">
              {/* Custom Navigation Buttons */}
              <button className="un-goals-prev text-accent flex items-center justify-center md:h-auto h-10 w-10 md:w-6 cursor-pointer bg-black md:bg-transparent p-[10px] leading-[1] md:p-0 rounded-full md:rounded-0" aria-label="Previous slide" >
              ...
              <button
                className="un-goals-next text-accent flex items-center justify-center md:h-auto w-10 h-10 md:w-6 cursor-pointer bg-black md:bg-transparent p-[10px] leading-[1] md:p-0 rounded-full md:rounded-0"

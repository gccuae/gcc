        ...
        <div>
          <div className="relative">
            <div className="absolute top-2/4 right-[-10px] xl:top-4/6 xl:-right-12 z-50 w-[50px] h-[50px] xl:w-[94px] xl:h-[94px] bg-black rounded-full flex items-center justify-center gap-4 xl:gap-4">
              ...
              <button
                className="un-goals-prev text-accent flex items-center justify-center h-auto w-6 cursor-pointer"
                aria-label="Previous slide"
              >
                <svg width="15" height="26" viewBox="0 0 15 26" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-3 h-full" >
                  <path d="M14 1L2 13L14 25" stroke="#7AC142" strokeWidth="2" strokeLinecap="round" />
                </svg>
              </button>
              <button
                className="un-goals-next text-accent flex items-center justify-center h-auto w-6 cursor-pointer"
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between xl:max-h-[35em] overflow-hidden z-40 relative group">
                      ...
                      <div className="mt-auto overflow-hidden group-first:pl-0 relative z-20 xl:pt-27px pt-3 max-xl:h-[400px]">
                        <Image
                          src={item.image}
                          alt={item.imageAlt}
                          width={487}
                          height={403}
                          className="w-full h-full object-cover object-top flex overflow-hidden pl-0 pr-0 xl:pl-[15px] xl:pr-[15px] group-first:pl-0 xl:min-h-[403px]"
                        />
                      </div>
                    </div>
                    </motion.div>

      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 xl:gap-10">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full pb-3 border-b-2 transition-colors duration-200 focus:outline-none placeholder:text-lg placeholder:text-[#979797] placeholder:font-normal placeholder:leading-lh-base ${errors.lastName
                ? 'border-red-500 bg-red-50'
                : 'border-[#C2C2C2]/35 focus:border-black'
                }`}
              {...register('lastName', {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 xl:gap-10">
          <div>
            ...
            <input
              ...
              className={`w-full pb-3 border-b-2 transition-colors duration-200 focus:outline-none  placeholder:text-lg placeholder:text-[#979797] placeholder:font-normal placeholder:leading-lh-base ${errors.email
                ? 'border-red-500 bg-red-50'
                : 'border-[#C2C2C2]/35 focus:border-black'
                }`}
              {...register('email', {
          ...
          <div>
            ...
            <input
              ...
              className={`w-full pb-3 border-b-2 transition-colors duration-200 focus:outline-none placeholder:text-lg placeholder:text-[#979797] placeholder:font-normal placeholder:leading-lh-base ${errors.contact
                ? 'border-red-500 bg-red-50'
                : 'border-[#C2C2C2]/35 focus:border-black'
                }`}
              {...register('contact', {
        ...
        <div>
          ...
          <textarea
            ...
            maxLength={1000}
            className={`w-full pb-3 border-b-2 transition-colors duration-200 focus:outline-none resize-vertical placeholder:text-lg placeholder:text-[#979797] placeholder:font-normal placeholder:leading-lh-base ${errors.message
              ? 'border-red-500 bg-red-50'
              : 'border-[#C2C2C2]/35 focus:border-black'
              }`}
            {...register('message', {
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-start space-x-3">
            <input
              type="checkbox"
              id="acceptPrivacy"
              className={`mt-1 h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 ${errors.acceptPrivacy ? 'border-red-500' : ''
                }`}
          ...
          {errors.acceptPrivacy && (
            <p className="text-sm text-red-600 -mt-2">{errors.acceptPrivacy.message}</p>
          )}

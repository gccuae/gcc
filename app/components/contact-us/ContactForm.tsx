      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 xl:gap-10">
          ...
          >
            <label
              htmlFor="firstName"
              className="block text-base font-normal leading-lh-base text-gray-700 mb-4 xl:mb-9"
            >
              {" "}
              First Name{" "}
            </label>
            <input
              ...
              className={`w-full pb-3 border-b-2 transition-colors duration-200 focus:outline-none  placeholder:text-lg placeholder:text-[#979797] placeholder:font-normal placeholder:leading-lh-base ${
                errors.firstName
          ...
          >
            <label
              htmlFor="lastName"
              className="block text-sm font-medium text-gray-700 mb-4 xl:mb-9"
            >
              Last Name
            </label>
            <input
        ...
        >
          ...
          <textarea
            ...
            maxLength={1000}
            className={`w-full pb-3 border-b-2 transition-colors duration-200 focus:outline-none resize-vertical placeholder:text-lg placeholder:text-[#979797] placeholder:font-normal placeholder:leading-lh-base ${
              errors.message
                ? "border-red-500 bg-red-50"
                : "border-[#C2C2C2]/35 focus:border-black"
            }`}

...
const EnvironmentModal: React.FC<EnvironmentModalProps> = ({
  ...
  const showThumbControls = imageCount > 1;
            ...
            <div className="relative mt-4 px-6 sm:mt-[15px] sm:px-8 lg:mt-[30px]">
              <button
                ...
                className={`absolute left-0 top-1/2 z-20 -translate-y-1/2 ${
                  !hasImages ? "cursor-default opacity-40" : "cursor-pointer opacity-100"
                }`}
              >
              ...
              <div className="scrollbar-none flex items-center justify-start gap-[10px] overflow-x-auto scroll-smooth px-1">
                {item.images.map((img, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className="relative flex-shrink-0 cursor-pointer overflow-hidden rounded-[9px] transition-all duration-200"
                      style={{
                    ...
                    >
                      ...
                      />
                      {!isActive && (
                        <div className="pointer-events-none absolute inset-0 rounded-[9px] bg-white/60 transition-opacity duration-200" />
                      )}
                    </button>
                  );
                })}

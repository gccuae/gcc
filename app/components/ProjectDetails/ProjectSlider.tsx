                  ...
                  <div className="relative z-50">
                    ...
                    <div className="relative mb-5">
                      ...
                      <div className="w-full h-3 bg-gray-300 rounded-full overflow-hidden shadow-inner relative">
                        {/* Progress Fill */}
                        <div className="h-full bg-gradient-to-r from-green-500 to-green-600 rounded-full transition-all duration-300 ease-out shadow-sm" style={{ width: `${progress}%` }} />
                      ...
                      <div className="absolute -top-12 bg-white border border-gray-200 px-[10px] py-[5.5px] rounded-md shadow-md transition-all duration-300 ease-out"
                        style={{

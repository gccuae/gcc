    ...
    <section className="py-57px">
      <div className="container">
        <div className="relative h-fit">
          ...
          >
            {data?.firstSection?.images.map((image, index) => (
                  ...
                  <div className="relative z-50">
                    <div className="grid grid-cols-[auto_1fr] lg:gap-y-5 xl:gap-y-7">
                      {[
                        ...
                        {
                          label: "Location",
                          value: data?.secondSection?.location?.name,
                        },
                        {
                          label: "Scope of Work",
                          value: data?.secondSection?.scopeOfWork,
                        },
                        {
                        ...
                        <div
                          key={label}
                          className="border-b border-white/65 pb-3 xl:even:pl-10"
                        >

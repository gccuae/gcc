...
const ProjectSlider = ({ data }: ProjectSliderProps) => {
  ...
  const renderOverlay = () => (
    <div className="absolute bottom-0 md:bottom-30px right-0 lg:right-30px z-40 p-5 xl:p-30px max-w-fit xl:max-w-[515px] border dark:border-white/20/36">
      ...
      <div className="relative z-50">
        <div className="grid grid-cols-[auto_1fr] lg:gap-y-5 xl:gap-y-7">
          {[
            ...
            <div key={label} className="border-b border-white/65 pb-3 xl:even:pl-10">

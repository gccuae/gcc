            ...
            >
                ...
                <motion.div variants={moveUp(1)} initial="hidden" whileInView="show" viewport={{ once: true }}>
                    <button
                        ...
                        className="hover:bg-primary hover:text-white flex items-center justify-center py-1 xl:py-[7.39px] px-4 xl:px-[28px] gap-2 transition-all duration-300 border border-foreground rounded-4xl"
                    >

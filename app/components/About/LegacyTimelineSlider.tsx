...
const LegacyTimelineSlider = ({
  ...
  <AnimatePresence initial={false} mode="popLayout">
    ...
    >
      <Image
        src={doubledTimelineData.items[activeSlide].backgroundImage}
        alt=""
        fill
        ...
        <div className="bg-black overflow-hidden">
          <div className="container relative h-full">
            ...
            <div className=" absolute  bottom-0 lg:bottom-auto mb-2 md:mb-0 lg:top-12 xl:top-19 right-3 md:right-0 flex items-center z-10 lg:h-full">
              <div className="max-w-[300px] sm:max-w-[400px] md:max-w-[700px] lg:max-w-[500px] overflow-hidden h-full relative right-3 md:right-9 top-1 md:top-0">
                <Swiper
                  onSwiper={(swiper) => {
                  ...
                  breakpoints={{
                    ...
                    400: { slidesPerView: 5, spaceBetween: 22 },
                  ...
                  {doubledTimelineData.items.map((item, index) => (
                    ...
                    >
                      <button 
                        ...
                        className={`font-normal  duration-500 text-lg leading-[32px] pb-5 hover:text-white whitespace-nowrap ${
                          activeSlide === index

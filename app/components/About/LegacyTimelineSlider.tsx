          ...
          <div className="container relative h-full">
            ...
            <div className="absolute bottom-0 lg:bottom-auto mb-2 md:mb-0  lg:top-12 xl:top-19 right-3 md:right-0 flex items-center z-10 lg:h-full">
              ...
              <div className="overflow-hidden h-full relative right-3 md:right-9 top-1 md:top-0">
                ...
                >
                  {data.map((item, index) => (
                    <SwiperSlide key={`year-${item.year}-${index}`} className="!w-[60px] md:!w-[85px] !flex items-center flex-col justify-center">
                      <button
              ...
              <SwiperSlide key={item.year} className="history-slide">
                <div className="  w-full">
                  <div className="container relative z-10">
                    {/* Year Display */}
                    <div className="text-5xl text-white mb-3 opacity-90">
                      {item.year}
                    </div>

                    {/* Title */}
                    <h2 className="text-xl  font-medium text-white mb-3 leading-tight">
                      {item.title}
                    </h2>

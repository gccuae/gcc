      ...
      <div className="container">
        <div className="mb-6 xl:mb-[47px]">
          <motion.h2
            ...
            initial="hidden"
            whileInView="show"
            className="text-4xl 2xl:text-5xl leading-[1.147058823529412] font-normal mb-2 xl:mb-[27px] text-black dark:text-white letterSp-2"
          >
            {data.title}
          </motion.h2>
          <motion.p
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="show"
          className="grid grid-cols-2 lg:grid-cols-4 border-t border-l border-r dark:border-white/20 dark:border-[#3f3f3f]"
        >
          {data.items.map((item: FirstSectionItem, index: number) => (
            <motion.div
              ...
              initial="hidden"
              whileInView="show"
              className="border-b lg:border-b-0 border-r dark:border-[#3f3f3f] dark:border-white/20 last:border-r-0 [&:nth-child(2)]:border-r-0 [&:nth-child(4)]:border-r-0 lg:[&:nth-child(2)]:border-r-1
            ...
            >
              <div>
                ...
                <h3 className=" text-4xl 2xl:text-5xl leading-lh-text68 font-normal mb-3 md:mb-4 xl:mb-[16px] text-black dark:text-white group-hover:text-white transition-all duration-300">

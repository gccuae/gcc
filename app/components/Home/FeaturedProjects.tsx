    ...
    <section className="bg-[#F5F3F0]">
      ...
      <div className="container" ref={containerRef}>
        <div className="md:flex justify-between items-center py-8 md:pt-[53px] md:pb-[57px] border-b border-[#C2C2C2]">
          <h2 className="text-5xl font-normal text-black mb-8 md:mb-0">{data.title}</h2>
          <div className="  flex gap-3 md:gap-5 items-center  ">
            <div className=" flex   border border-foreground rounded-full ">
              <div 
                ref={prevRef}
        ...
        <div className="onside-margin px-4" style={{ marginLeft: `${rightMargin}px` }}> 
          <div className="flex md:flex-row flex-col-reverse"> 
            ...
            <Swiper
                ...
                <SwiperSlide key={index} >
                      ...
                      <div className="w-full lg:w-[80%]">
                        <div className="pb-4 mb-6 border-b border-[#C2C2C2]"> 
            ...
            <div className="pb-0 pt-10 md:py-10 md:ps-10 md:w-[68.5%] w-full">
            <Swiper
                  modules={[Autoplay,Navigation]}
                  // autoplay={{ delay: 4000 }}  
                  loop

                ...
                <SwiperSlide key={index} className="border-t-1 border-r-1 border-foreground relative group">
                  ...
                  <div className="flex flex-col justify-between xl:max-h-[39em] overflow-hidden z-40 relative">
                    <motion.div variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} 
                      className="flex items-center justify-between mb-3 xl:mb-[25px] pl-4 pr-3 pt-6 group-hover:xl:pl-[37px] group-hover:xl:pt-[35px] group-hover:xl:pr-[35px] group-first:pl-0 ">
                    ...
                    <div className="pl-4 pr-3 pt-6 group-hover:xl:pl-[37px] group-hover:xl:pt-[35px] group-hover:xl:pr-[35px] group-first:pl-0 ">
                    ...
                    <div className="mt-auto overflow-hidden pr-[15px] pl-[15px] group-first:pl-0">

...
export const MenuItem = ({
    ...
    return (
        <div
            ...
            className="relative mr-0 not-first:ml-3 not-first:xl:ml-[15px] not-first:2xl:ml-[20px]"
        >
                ...
                <motion.div key="header-menu" {...slideDown()} className="bg-white dark:bg-black">
                    ...
                    <div className="relative" style={{ marginLeft: `${rightMargin}px` }}>
                        <nav
                            ...
                            className="relative z-50 flex justify-center items-stretch h-full"
                        >
                            {/* <div className="pr-[28px] xxl:pr-[28px] xxxl:pr-[50px] w-full flex items-center justify-between gap-3 py-[10px]"> */}
                            <div className="pr-3 w-full flex items-center justify-between gap-1 py-[10px]">
                                <div className="">
                                    <Link href="/">
                                ...
                                <div>
                                    <div className="flex items-center gap-4 w-fit ml-auto  mb-[19px] ">
                                        <div className="flex items-center justify-end gap-2">
                                            <Link
                                                href="https://www.facebook.com/profile.php?id=61585660241145"
                                                target="_blank"
                                            ...
                                            <Link
                                                href="https://www.youtube.com/@GCCae"
                                                target="_blank"
                                                className="w-8 h-8 rounded-full group hover:bg-primary border border-[#C2C2C2] bg-white hover:border-none cursor-pointer flex items-center justify-center group"
                                            >
                                                <Image
                            ...
                            <div className="rghtsc flex flex-col justify-center ml-[2px] bg-primary px-6 xl:px-10 ">
                                <div className="rounded-full px-6 py-[7px] border border-white hover:bg-white transition-all duration-300 hover:scale-110 group">
                                    <Link
                                        href="/contact-us"
                                        className="flex flex-1 justify-center items-center transition h-full w-full gap-2 "
                                    >
                                        <span className="text-white text-base leading-[1.82] group-hover:text-primary transition-all duration-200">
                                            CONTACT
                                        </span>
                                    </Link>
                                </div>
                        ...
                        <div className="p-6 h-full">
                            <div className="space-y-6">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="text-sm text-gray-500">Press Enter to search or Escape to close</div>
                                    <button
                            ...
                            <div className="mt-5 px-4 flex flex-col gap-5 text-black h-[300px]">
                                {" "}
                                {/* 👈 fixed height */}

    ...
    >
      ...
      <nav
        ...
        <div className="  pr-[28px] xxl:pr-[28px] xxxl:pr-[50px] w-full flex items-center justify-between gap-3 py-[10px]  " >
          ...
          <div className="rghtsc flex flex-col justify-center ml-[2px] bg-primary px-6 xl:px-10   group">
        <div className="rounded-full px-6 py-[7px] border border-white"> 
          <Link href="/contact" className="flex flex-1 justify-center items-center transition h-full w-full gap-2">
          <span className="text-white text-base  leading-[1.82]">CONTACT</span> 
        </Link> 
        </div>

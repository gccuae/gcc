      ...
      <div className="relative h-full">
        ...
        <div className="container relative z-2">
          <div className="pt-10 pb-6 xl:pb-37px xl:pt-[63px] border-b border-foreground">
            <motion.h2
              className="text-5xl font-normal leading-[1.147058823529412] text-white max-w-3xl"
              variants={moveUp(0)}
              initial="hidden"
              whileInView="show"
          ...
          <div className="grid gap-y-8 lg:grid-cols-2 xl:grid-cols-[6fr_4fr] pt-4 pb-4 xl:pt-27px xl:pb-27px border-b border-foreground">
            <div>
              <motion.p
                className="text-lg font-normal text-white leading-[1.526315789473684] max-w-[472px]"
                variants={moveUp(0.2)}
                initial="hidden"
                whileInView="show"
                viewport={{ once: true, amount: 0.2 }}
              ...
              <div className="flex flex-col gap-2 pt-3 xl:pt-[18px]">
                ...
                >
                  ...
                  <Link
                    ...
                    className="text-lg xl:text-2xl font-normal text-white leading-[1.3125] hover:text-accent transition-all duration-300"
                  >
                    info@gcc.ae
                  </Link>
                </motion.div>
                ...
                >
                  ...
                  <Link
                    ...
                    className="text-lg xl:text-2xl font-normal text-white leading-[1.3125] hover:text-accent transition-colors duration-300"
                  >
                    +971 2 626 7510
                  </Link>
                </motion.div>
            ...
            <div>
              <motion.h3
                ...
                whileInView="show"
                viewport={{ once: true, amount: 0.2 }}
                className="text-2xl font-normal text-white leading-[1.3125] pb-4 xl:pb-[37px]"
              >
                Quick Links
              </motion.h3>
                ...
                <div>
                  <ul className="flex flex-col gap-2">
                    <motion.li
                      ...
                      whileInView="show"
                      viewport={{ once: true, amount: 0.2 }}
                      className="text-white text-lg font-light leading-[1.578947368421053] hover:text-accent transition-colors duration-300"
                    >
                      <Link href="#">About GCC</Link>
                    </motion.li>
                    <motion.li
                ...
                <div>
                  <ul className="flex flex-col gap-2">
                    <motion.li
                      ...
                      className="text-white text-lg font-light leading-[1.578947368421053] hover:text-accent transition-colors duration-300"
                    >
                      <Link href="#">Clientele & Partnerships</Link>
                    </motion.li>
                    <motion.li
                      variants={moveUp(0.1)}
                      initial="hidden"
                    ...
                    <motion.li
                      ...
                      className="text-white text-lg font-light leading-[1.578947368421053] hover:text-accent transition-colors duration-300"
                    >
                      <Link href="#">Health Safety & Environmental</Link>
                    </motion.li>
                    <motion.li
                      variants={moveUp(0.3)}
                      initial="hidden"
            ...
            <div className="flex flex-wrap gap-4 xl:gap-6">
              ...
              >
                <Link href="#" className="flex items-center gap-2">
                  <span className="text-mdgray text-lg font-light leading-[1.578947368421053] uppercase hover:text-primary transition-colors duration-300">
                    LinkedIn
                  </span>
                  <Image
            ...
            >
              ...
              >
                ...
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-5 h-5 xl:w-[33px] xl:h-[33px]"
                >
                  <path
          ...
          <div className="flex flex-wrap justify-between items-center">
            <ul className="flex items-center gap-4 xl:gap-8">
              ...
              >
                <Link
                  href="#"
                  className="text-base leading-[1.875] font-light text-mdgray hover:text-accent transition-colors duration-300"
                >
                  Terms & Conditions
                </Link>
              </motion.li>

      ...
      <div className="relative h-full">
        ...
        <div className="container relative z-2">
          ...
          <div className="grid gap-y-8 md:gap-x-6 md:grid-cols-2 xl:grid-cols-[6fr_4fr] pt-4 pb-4 xl:pt-27px xl:pb-27px border-b border-para-color">
            <div>
              {!data.secondSection.hidden && (
                <div className="flex flex-col gap-y-4 lg:gap-3 pt-0 xl:pt-4 pb-5">
                  <motion.p
                  ...
                  >
                    ...
                    <Link
                      href={`mailto:${data.secondSection.email}`}
          ...
          <div className="grid lg:grid-cols-2 xl:grid-cols-[6fr_4fr] pt-6 pb-8 xl:pt-8 xl:pb-27px gap-y-8">
            {!data.forthSection.hidden && (
              <div className="flex flex-wrap gap-x-8 sm:gap-x-10 xl:gap-x-6">
                  ...
                  >
                    <Link href={item.link} className="flex items-center gap-2">
                      ...
                      <Image
                        ...
                        width={22}
                        height={22}
                        className="w-3 h-3 md:w-5 md:h-5 xl:w-[10.97px] xl:h-auto"
                      />
                    </Link>
                  </motion.div>
                ))}

      ...
      >
        ...
        <ul className="flex gap-3 items-center">
          ...
          <motion.li
            ...
            viewport={{ once: true }}
          >
            <Link href="https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Fgcc-eta.vercel.app%2F" target="_blank" rel="noopener noreferrer">
          ...
          <motion.li
            ...
            viewport={{ once: true }}
          >
            <Link href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fgcc-eta.vercel.app%2F" target="_blank" rel="noopener noreferrer">
              <svg
                width="8"
                height="15"
                viewBox="0 0 8 15"
          ...
          <motion.li
            ...
            viewport={{ once: true }}
          >
            <Link href="https://twitter.com/intent/tweet?text=Check%20out%20this%20article:&url=https%3A%2F%2Fgcc-eta.vercel.app%2F" target="_blank" rel="noopener noreferrer">
              <svg
                width="14"
                height="15"
                viewBox="0 0 14 15"

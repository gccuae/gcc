                    ...
                    <div className='grid grid-cols-2 gap-2'>
                        <div className='flex flex-col gap-2'>
                            <div>
                                ...
                                <ImageUploader onChange={(url) => setValue("thumbnail", url)} value={watch("thumbnail")} recommendedDimension='Recommended: 500 x 580 (px)' />
                        ...
                        <div className='flex flex-col gap-2'>
                            <div>
                                ...
                                <ImageUploader onChange={(url) => setValue("coverPhoto", url)} value={watch("coverPhoto")} recommendedDimension='Recommended: 1920 x 757 (px)' />

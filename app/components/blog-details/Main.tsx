  ...
  return (
    <section className="py-57px dark:bg-black">
      <div className="container">
        ...
        <div ref={divRef} className="mb-4 md:mb-27px overflow-hidden">
          <Image src={mainImage} alt="blog-details" width={1920} height={1280} className="w-full object-cover h-[250px] sm:h-[320px] md:h-[400px] lg:h-[500px] 2xl:h-[600px] " />
        </div>
        <div ref={divRef} className="mb-47px blog-details overflow-hidden" dangerouslySetInnerHTML={{ __html: content }} />
        ...
        {quote && (
          <motion.div variants={moveUp()} initial="hidden" whileInView="show">
            <div className="bg-[#1c1c1c] border-l-6 border-primary dark:border-accent max-w-[938px] pl-6 pr-6 py-6 md:pl-14 md:pr-14 xl:pl-[71px] xl:pr-[72px]  md:py-15 xl:py-[81px] relative">
              <motion.h3 variants={moveUp(0.15)} initial="hidden" whileInView="show" className="xl:text-xl leading-lh-text32 font-light mb-2 xl:mb-3 text-white" >
                {quote}
              </motion.h3>
              <div className="flex items-center justify-between">
                <motion.p variants={moveUp(0.2)} initial="hidden" whileInView="show" className="text-lg leading-lh-text19 font-medium text-white w-fit" >
                  {quoteAuthor ?? ""}
                </motion.p>
                <motion.div variants={moveLeft(0.2)} initial="hidden" whileInView="show" >

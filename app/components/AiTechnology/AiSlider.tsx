                  ...
                  >
                    <div className="transition-all duration-300">
                      ...
                      <div
                        ...
                        className={`bgsre transition-all duration-300 cursor-pointer border-b border-[#c2c2c2] ${activeIndex === index
                            ? "bg-primary"
                      ...
                      <div className={`px-6 lg:px-10 py-57px transition-all duration-500 ${activeIndex === index

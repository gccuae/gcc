        ...
        <div className="bg-light-white dark:bg-gray-900 pb-6 lg:pb-0 pt-57px">
          <div className="container">
            ...
            <div className="flex md:flex-row flex-col border-y border-smgray dark:border-gray-700 gap-2 md:gap-0 xl:gap-12 ">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`bg-white dark:bg-gray-900 md:bg-transparent px-2 lg:px-4 py-3 cursor-pointer  font-medium text-xl leading-[1.2]  xl:leading-[2.173913043478261] transition-all duration-300 border-t-4 whitespace-nowrap ${
                    activeTab === tab.id
                      ? "text-black dark:text-green-400 border-accent dark:border-green-400"
                      : " dark:text-gray-400 border-transparent hover:text-black  dark:hover:text-white "
                  }`}
                >
                  {tab.label}
                </button>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-[3fr_1.9fr]">
              ...
              <div className="lg:border-r border-smgray dark:border-gray-700 lg:pr-[67px] xl:pr-[67px] pt-6 xl:pt-[47px]">
                {/* Items List */}
                  ...
                  {filteredItems.map((item, index) => (
                    <div key={`${item.category}-${index}`}>
                      <button
                        ...
                        className={`w-full text-left flex items-center justify-between pb-4 xl:pb-[27px] mb-4 xl:mb-[27px] border-b border-smgray last:border-b-0 dark:border-gray-700 transition-all duration-200 group ${
                          selectedItem === item ? "border-b-primary" : ""
                        }`}
                      >
                        <div>
                          <h3
                            className={`font-medium text-xl leading-normal mb-1 group-hover:text-black group-hover:dark:text-white/70 ${
                              selectedItem === item

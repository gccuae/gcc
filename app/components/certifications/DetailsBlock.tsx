  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="bg-[#ebebeb] dark:bg-[#0d0d0d] py-2 xl:py-[13.74px] flex justify-center relative group">
        <Image src={selectedItem.thumbnail} alt={selectedItem.title} width={500} height={500} className="object-contain w-auto h-[300px] md:h-[450px]" />
        ...
        <div className="absolute inset-0 w-full h-full z-10 bg-black/63 flex items-center justify-center opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300">
          <button onClick={handleOpenModal} className="rounded-full bg-white w-10 h-10  md:w-15 md:h-15 xl:w-[91.73px] xl:h-[91.73px] flex items-center justify-center cursor-pointer transition-all duration-300"
          >
            <Image src={assets} alt={selectedItem.title} width={50} height={50} className="w-5 h-5 md:w-6 md:h-6 xl:w-auto xl:h-8 transition-all duration-300" />
          </button>
        </div>
        <button
        ...
        >
          <svg width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 md:w-6 md:h-6" >
            <path
      ...
      <div className="pt-0 xl:pt-[19.74px]">
        <div className="flex align-items-end justify-between mb-0 pb-4 xl:pb-[22.9px] last:mb-0 group border-b dark:border-white/20 hover:border-primary transition-colors duration-300">
          <div>

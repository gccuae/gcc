      ...
      <div className="container">
        <div className="relative z-10">
          ...
          <div className="lg:w-2/4 ml-auto">
            ...
            <Link href={data.slug}
              className="flex items-center justify-between gap-4 bg-light-white dark:bg-white rounded-3xl w-fit py-2 px-30px xl:py-2 xl:px-40px  transition-all duration-300 hover:bg-primary hover:text-white text-black mt-12 xl:mt-[67px] text-base leading-[1.75] group"
            >
              {data.buttonText}

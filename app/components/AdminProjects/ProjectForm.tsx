...
const ProjectForm = ({ editMode }: { editMode?: boolean }) => {
    ...
    const { register, handleSubmit, setValue, control, formState: { errors },watch } = useForm<ProjectFormProps>();
    ...
    const handleAddProject = async (data: ProjectFormProps) => {
        try {
            const response = await fetch(editMode ? `/api/admin/projects?id=${id}` : `/api/admin/projects`, {
  ...
  const fetchServices = async () => {
    ...
    useEffect(() => {
        ...
        if (editMode) {
            ...
            handleFetchLocation().then(() => handleFetchSector()).then(() => handleFetchProjectType());
        }
    }, []);
    ...
    return (
        <div className='flex flex-col gap-5'>
            <form className='flex flex-col gap-5' onSubmit={handleSubmit(handleAddProject)}>
                    ...
                    <div className='p-5 rounded-md grid grid-cols-2 gap-5'>
                        ...
                        <div className='flex flex-col gap-1'>
                            ...
                            <div className='flex flex-col gap-1'>
                                ...
                                <Input type='text' placeholder='Longitude' {...register("longitude")} />
                            </div>
                        </div>
                    </div>
                </AdminItemContainer>
                    ...
                    <div className='p-5 rounded-md flex flex-col gap-2'>
                        <div className='flex flex-col gap-2'>
                            ...
                            <div className='flex flex-col gap-1'>
                                ...
                                <Input type='text' placeholder='Progress' {...register("secondSection.progress", {
                                    required: "Progress is required"
                                })} />
                                {errors.secondSection?.progress && <p className='text-red-500'>{errors.secondSection?.progress.message}</p>}
                            </div>
                            <div className='flex flex-col gap-1'>
                                <Label className='font-bold'>Client</Label>
                                <Input type='text' placeholder='Client' {...register("secondSection.client", {
                                    required: "Client is required"
                                })} />
                                {errors.secondSection?.client && <p className='text-red-500'>{errors.secondSection?.client.message}</p>}
                            </div>
                            <div className='flex flex-col gap-1'>
                                <Label className='font-bold'>Scope Of Work</Label>
                                <Input type='text' placeholder='Scope Of Work' {...register("secondSection.scopeOfWork", {
                                    required: "Scope Of Work is required"
                                })} />
                                {errors.secondSection?.scopeOfWork && <p className='text-red-500'>{errors.secondSection?.scopeOfWork.message}</p>}
                            </div>
                            <div className='flex flex-col gap-1'>
                                <Label className='font-bold'>Completion Date</Label>
                                <Input type='text' placeholder='Completion Date' {...register("secondSection.completionDate", {
                                    required: "Completion Date is required"
                                })} />
                                {errors.secondSection?.completionDate && <p className='text-red-500'>{errors.secondSection?.completionDate.message}</p>}
                            </div>
                            <div className='flex flex-col gap-1'>
                                <Label className='font-bold'>Project Value</Label>
                                <Input type='text' placeholder='Project Value' {...register("secondSection.projectValue", {
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    />
                    {errors.secondSection?.projectType && <p className="text-red-500">{errors.secondSection?.projectType.message}</p>}
                ...
                <AdminItemContainer>
                    ...
                    <div className='p-5 rounded-md flex flex-col gap-3'>
                                ...
                                <div key={field.id} className='grid grid-cols-2 gap-2 relative border-b pb-2 last:border-b-0'>
                                    ...
                                    <div>
                                        ...
                                        <div className='flex flex-col gap-2'>
                                            ...
                                            <Textarea placeholder='Description' {...register(`forthSection.items.${index}.description`)} />
                                        </div>
                        ...
                        <div className='flex justify-end mt-2'>
                            <Button type='button' addItem onClick={() => forthSectionAppend({ title: "", description: "" })}>Add Item</Button>
                        </div>

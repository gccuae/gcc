...
export async function GET(request: NextRequest) {
    try {
        ...
        if(id){
            ...
            return NextResponse.json({data:expertise,message:"Expertise fetched successfully"}, { status: 200 });
        }
    } catch (error) {
        console.log(error);
        ...
        if(id){
            ...
            if(expertise){
                ...
                if(itemToUpdate){
                    ...
                    return NextResponse.json({message:"Expertise updated successfully"}, { status: 200 });
                }
            }
